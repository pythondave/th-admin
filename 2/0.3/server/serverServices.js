...
app.factory('randomDataService', function(serverListsService) {
  ...
  var getRandomParagraph = function(minSentences, maxSentences) {
    minSentences = minSentences || 1; maxSentences = maxSentences || 4;
  ...
  var getRandomApplicationForStatusId1 = function() {
    return {
      "id": _.uniqueId(),
      //"score": getRandomDataItem('score'), //only general teacher score needed
      "teacher": getRandomObject(['id', 'fullName', 'profileUrl', 'score']),
      "job": getRandomObject(['id', 'subject', 'role', 'schoolName', 'country']),
      "coverMessage": getRandomMultiParagraphMessage(1, 10),
